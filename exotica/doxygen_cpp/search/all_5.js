...
[
  ...
  ['eigen_5fautodiff_5fdeclare_5fglobal_5funary',['EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY',['../autodiff__scalar_8h.html#ac5e00a64ead53610197810e5a31f663d',1,'EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY():&#160;autodiff_scalar.h'],['../namespaceEigen.html#a5bcaf28220770e873e05064f1afa97f1',1,'Eigen::EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(abs, using std::abs;return Eigen::MakeAutoDiffScalar(abs(x.value()), x.derivatives()*(x.value()&lt; 0?-1:1));) EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(abs2'],['../namespaceEigen.html#ab92978c282e602b8e871ad8d1e21f1d6',1,'Eigen::EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(sqrt, using std::sqrt;Scalar sqrtx=sqrt(x.value());return Eigen::MakeAutoDiffScalar(sqrtx, x.derivatives()*(Scalar(0.5)/sqrtx));) EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(cos'],['../namespaceEigen.html#ad42b54cffefda1cd7f77cb78e428e0d2',1,'Eigen::EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(sin, using std::sin;using std::cos;return Eigen::MakeAutoDiffScalar(sin(x.value()), x.derivatives()*cos(x.value()));) EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(exp'],['../namespaceEigen.html#aae7533224255413bea916fe9a7d831c1',1,'Eigen::EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(log, using std::log;return Eigen::MakeAutoDiffScalar(log(x.value()), x.derivatives()*(Scalar(1)/x.value()));) template&lt; typename DerType &gt; inline const Eigen'],['../namespaceEigen.html#add4353e5966cea50ccdc71d41dc9f6e8',1,'Eigen::EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(tan, using std::tan;using std::cos;return Eigen::MakeAutoDiffScalar(tan(x.value()), x.derivatives()*(Scalar(1)/numext::abs2(cos(x.value()))));) EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(asin'],['../namespaceEigen.html#a16972eba8e0d7812148a53d15371ef58',1,'Eigen::EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(acos, using std::sqrt;using std::acos;return Eigen::MakeAutoDiffScalar(acos(x.value()), x.derivatives()*(Scalar(-1)/sqrt(1-numext::abs2(x.value()))));) EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(tanh'],['../namespaceEigen.html#ac482b890c0bd2499bbc79e5f36dc21ee',1,'Eigen::EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(sinh, using std::sinh;using std::cosh;return Eigen::MakeAutoDiffScalar(sinh(x.value()), x.derivatives()*cosh(x.value()));) EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(cosh']]],
  ...
  ['estsolver',['ESTSolver',['../classexotica_1_1ESTSolver.html#ae61f7a14e6a4ee4befeae66a033f95cb',1,'exotica::ESTSolver']]],
